...
from tools.embed import create_user_info_embed
...
class Roster(interactions.Extension):
            ...
            interactions.Option(
                ...
                options=[
                    ...
                    interactions.Option(
                        type=interactions.OptionType.STRING,
                        name='bio',
                        description='Your short biography',
                        required=False
                    ),
                ]
            ),
    ...
    async def profile_command(
        ...
        match ctx.data.options[0].name:
            ...
            case 'edit':
                if config.Guild
                await self._edit_profile(ctx, user, youtube, bio)
